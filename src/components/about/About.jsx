  ...
  return (
    <div className="a">
      ...
      <div className="a-right">
        ...
        <p className="a-desc">
          Saya menempuh pendidikan sarjana di Universitas Negeri Yogyakarta dengan Prodi Pendidikan Teknik Elektronika, sempat bekerja pada bidang customer service hingga akhirnya menemukan passion saya pada bidang Software Engineer.
        </p>
